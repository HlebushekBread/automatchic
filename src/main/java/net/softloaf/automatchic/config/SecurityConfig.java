package net.softloaf.automatchic.config;

import lombok.RequiredArgsConstructor;
import net.softloaf.automatchic.security.JwtRequestFilter;
    ...
    public SecurityFilterChain getSecurityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/api/subjects/delete/{id}").authenticated()
                        .requestMatchers("/api/subjects/copy/{id}").authenticated()
                        .requestMatchers("/api/subjects/save").authenticated()
                        .requestMatchers("/api/subjects/user").authenticated()
                        .requestMatchers("/api/subjects/public").permitAll()
                        .requestMatchers("/api/subjects/view/{id}").authenticated()
