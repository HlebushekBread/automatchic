    ...
    public SecurityFilterChain getSecurityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/api/v1/subjects/{id}/delete").authenticated()
                        .requestMatchers("/api/v1/subjects/{id}/copy").authenticated()
                        .requestMatchers("/api/v1/subjects/save").authenticated()
                        .requestMatchers("/api/v1/subjects/self").authenticated()
                        .requestMatchers("/api/v1/subjects/public").permitAll()
                        .requestMatchers("/api/v1/subjects/{id}/view").authenticated()
                        .requestMatchers("/api/v1/subjects/{id}/preview").permitAll()
                        .requestMatchers("/api/v1/tasks/{id}/delete").authenticated()
