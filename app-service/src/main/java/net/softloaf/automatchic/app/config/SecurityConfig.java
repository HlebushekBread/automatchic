...
import net.softloaf.automatchic.app.security.JwtRequestFilter;
    ...
    public SecurityFilterChain getSecurityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/api/v1/subjects/delete/{id}").authenticated()
                        .requestMatchers("/api/v1/subjects/copy/{id}").authenticated()
                        .requestMatchers("/api/v1/subjects/save").authenticated()
                        .requestMatchers("/api/v1/subjects/user").authenticated()
                        .requestMatchers("/api/v1/subjects/public").permitAll()
                        .requestMatchers("/api/v1/subjects/view/{id}").authenticated()
                        .requestMatchers("/api/v1/subjects/preview/{id}").permitAll()
                        .requestMatchers("/api/v1/tasks/delete/{id}").authenticated()
                        .requestMatchers("/api/v1/tasks/save").authenticated()
